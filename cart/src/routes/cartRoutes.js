...
router.get("/:userId", verifySignature, validateUserId, async (req, res) => {
...
router.post("/:userId", verifySignature, validateUserId, validateProductId(true), async (req, res) => {
    const userId = req.params["userId"];
...
router.delete("/:userId/product/:productId", verifySignature, validateUserId, validateProductId(false), async (req, res) => {
    const userId = req.params["userId"];
...
router.patch("/:userId/product/:productId", verifySignature, validateUserId, 
